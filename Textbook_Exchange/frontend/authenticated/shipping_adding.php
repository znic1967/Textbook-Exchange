...
?>
		...
		<div class="row">
	    	<div class="col-sm" id="maincol">
				...
				<form class="formCnt" method="post" action="/backend/shipping_inserting_process.php">
					<div class="row"><input type="text" placeholder="Receiver" name="name"></div>
					<div class="row"><input type="text" placeholder="Address" name="address"></div>
					<div class="row"><input type="text" placeholder="City" name="city"></div>
					<div class="row"><input type="text" placeholder="State" name="state"></div>
					<div class="row"><input type="text" placeholder="Zip" name="zip"></div>
					<div class="row"><input type="text" placeholder="Phone" name="phone"></div>
					<div id="btnpad">
						<button class="sButton" type="submit"> Add Shipping Address </button>
					</div>
				</form>
			</div>	
		</div>
