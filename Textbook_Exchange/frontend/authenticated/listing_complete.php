...
//=============== NEW IMPLEMENTATION ============================
	$recent_listing = $_SESSION['recent_listing'];
//=============== NEW IMPLEMENTATION ============================
?>
...
<?php
	if ($recent_listing['exmethod'] == "ship")
	{	
		unset($_SESSION['recent_listing']);
?>
		<div class="options">
			<h2>Your book has been posted, <?php echo $firstname; ?>!</h2>
			<a href="../../frontend/authenticated/listing.php">Sell another book</a>
		</div>
<?php
	}
	else
...
?>		
		<div class="options">
			<h2>Your book has been posted, <?php echo $firstname; ?>!</h2>
			<h2>Would you like to exchange with another book?</h2>
			<a href="../../frontend/authenticated/listing_inserting_exchange.php">Yes, insert a desired book</a>
			&emsp;&emsp; or &emsp;&emsp;
			<a href="../../frontend/authenticated/listing.php">No, sell another book</a>
		</div>
<?php
	}
?>
