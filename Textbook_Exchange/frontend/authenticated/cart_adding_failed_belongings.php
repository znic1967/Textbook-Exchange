...
?>
    ...
    <div class="options">
		<h2>You can't add this item to your cart. It belongs to you, <?php print $_SESSION["firstname"]?>!</h2>
	   <a href="../../backend/search_process.php">Continue Shopping</a>
	   <a href="../../backend/cart_displaying_process.php">Go to Cart</a>
	</div>
