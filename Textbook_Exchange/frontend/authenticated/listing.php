...
?>
		...
		<form method="post" action="../../backend/listing_process.php">
			...
			<table>
				...
				<tr>
					<td>Price</td>
					<td><input type="text" placeholder="$" name="price"></td>
				</tr>

			</table>

			<input type="submit" value="Sell Your Book">
